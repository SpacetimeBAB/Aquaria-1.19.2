...
public class BungaritusEntity extends TamableAnimal implements IAnimatable, Bucketable {
    ...
    public BungaritusEntity(EntityType<? extends TamableAnimal> p_30341_, Level p_30342_) {
...
//>>>>>>> Stashed changes
	...
	public AgeableMob getBreedOffspring(ServerLevel serverlevel, AgeableMob mob) {
			return EntityInit.BUNGARITUS.get().create(serverlevel);
