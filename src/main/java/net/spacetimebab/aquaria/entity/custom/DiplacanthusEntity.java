...
public class DiplacanthusEntity extends AbstractSchoolingFish implements IAnimatable, Bucketable {
    ...
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT=
            SynchedEntityData.defineId(DiplacanthusEntity.class, EntityDataSerializers.INT);
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_146746_, DifficultyInstance p_146747_,
        ...
        DiplacanthusVariant variant = Util.getRandom(DiplacanthusVariant.values(), this.random);
        setVariant(variant);
        return super.finalizeSpawn(p_146746_, p_146747_, p_146748_, p_146749_, p_146750_);
    }
    public DiplacanthusVariant getVariant() {
        return DiplacanthusVariant.byId(this.getTypeVariant() & 255);
    }
    ...
    private void setVariant(DiplacanthusVariant variant) {
